...
const Form = () => {
  return (
    <div className="bg-gray-800 w-full w-full flex">
      <div className="w-1/2">
      ...
      <div className="w-1/2 bg-green-800  rounded-md p-10 m-10">
        <input
          className="w-full text-gray-600 border-2 border-orange-400 bg-gray-800 h-10 px-5 pr-16 rounded-lg text-sm focus:outline-none mt-10 mb-10"
          type="search"
          name="search"
          placeholder="Marque"
        />
